...
class PFPascalDataset(CorrespondenceDataset):
    ...
    def __init__(self, benchmark, datapath, thres, device, split, img_side):
        r"""PF-PASCAL dataset constructor"""
        super(PFPascalDataset, self).__init__(benchmark, datapath, thres, device, split, img_side)
    ...
    def __getitem__(self, idx):
        ...
        # 20200920 for CL instance-level
        batch['index'] = idx
